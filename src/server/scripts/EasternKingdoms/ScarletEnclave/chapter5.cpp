...
public:
    ...
    bool OnGossipHello(Player* player, Creature* creature) override
    {
        ...
        if (player->GetQuestStatus(12801) == QUEST_STATUS_INCOMPLETE)
            player->ADD_GOSSIP_ITEM(0, "我准备好了。", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+1);
...
public:
    ...
    struct npc_the_lich_king_tirion_dawnAI : public ScriptedAI
    {
        ...
        void Reset() override { }
        void AttackStart(Unit* /*who*/) override { } // very sample, just don't make them aggreesive override
        void UpdateAI(uint32 /*diff*/) override { }
