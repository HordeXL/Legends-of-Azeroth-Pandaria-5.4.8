...
--
-- WHERE:  entryorguid IN (55787,55790) AND source_type=0

LOCK TABLES `smart_scripts` WRITE;
/*!40000 ALTER TABLE `smart_scripts` DISABLE KEYS */;
INSERT INTO `smart_scripts` VALUES (55790,0,0,0,0,0,100,0,2000,5000,12000,20000,0,11,115632,1,0,0,0,0,2,0,0,0,0,0,0,0,0,'Raging Beast Spirit - in combat - cast Spirit\'s Vengeance');
...
-- Dump completed on 2026-09-25  0:37:25
